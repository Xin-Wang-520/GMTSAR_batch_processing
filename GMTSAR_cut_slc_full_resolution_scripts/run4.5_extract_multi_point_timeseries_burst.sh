...
Usage:
  ./run4.5_extract_multi_point_timeseries_burst.sh [POINTS_FILE] [WINDOW_X WINDOW_Y]
  ./run4.5_extract_multi_point_timeseries_burst.sh LONGITUDE LATITUDE LABEL [WINDOW_X WINDOW_Y]
...
This script always reads sbas_burst; the default sampling window is 5 x 5 nodes.
...
Examples:
  ./run4.5_extract_multi_point_timeseries_burst.sh
  ./run4.5_extract_multi_point_timeseries_burst.sh my_points.txt
  ./run4.5_extract_multi_point_timeseries_burst.sh my_points.txt 3 3
  ./run4.5_extract_multi_point_timeseries_burst.sh 118.781 29.993 luoshixing
  ./run4.5_extract_multi_point_timeseries_burst.sh 118.781 29.993 luoshixing 3 3

Optional event marker:
  LANDSLIDE_DATE=2025-05-25 LANDSLIDE_LABEL=Landslide ./run4.5_extract_multi_point_timeseries_burst.sh ...

Inputs:
  burst/topo/dem.grd
  sbas_burst/supermaster.PRM
  sbas_burst/scene.tab
  sbas_burst/disp_<YYYYDDD>.grd
  sbas_burst/vel_ll.grd

Outputs in sbas_burst/run4.5_time_series/:
  points_radar.tsv
  time_series_all.tsv
